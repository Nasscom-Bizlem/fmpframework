...
get fetchserviceMaster(){
  return 'http://fetchmypayments.com:8052/BillingandServiceFullfillment/GetServiceMasterList';

}

get upgradetrial(){
  return 'http://fetchmypayments.com:8052/BillingandServiceFullfillment/Upgradefreetrialtoservice';

}
get serviceextension(){
  return 'http://fetchmypayments.com:8052/BillingandServiceFullfillment/ExtensionofService';
