...
import { ServiceextensionModel } from 'src/app/settings/fullfillment/service-extentions/serviceextension-model.model';
@Injectable({
  providedIn: 'root'
})
...
public callserviceextend(data: ServiceextensionModel) {
  return this.http
    .post<any>(this.globalConstants.serviceextension, data)
    .pipe(catchError(this.baseAuthSercvice.handleError));    
}
