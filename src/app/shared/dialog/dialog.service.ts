...
import { ViewOauthDialogComponent } from './view-oauth-dialog/view-oauth-dialog.component';
...
export class DialogService {
  ...
  openWhatsappAndSmsDialog(dialogTitle: string, modeldata: any) {
    const d = this.dialog.open(EditWhatsappDialogComponent, {
      data: {
        title: dialogTitle,
        modeldata: [],
  ...
  addMailhostDialog(mailHostModel?: MailHostModel) {
    const d = this.dialog.open(AddMailhostDialogComponent, {
      data: {
        // title: dialogTitle,
        //modeldata: [],
        modeldata: mailHostModel,
      },
      width: '50%',
      maxWidth: '50vw',
    });
 ...
 /*  addOauthDialog(dialogTitle: string, modeldata: any) {
  ...
  addOauthDialog(oAuthModel?: OAuth) {
    const d = this.dialog.open(AddOauthDialogComponent, {
      data: {
        // title: dialogTitle,
        //modeldata: [],
        modeldata: oAuthModel,
      },
      width: '25%',
      maxWidth: '25vw',
    });
  ...
  viewOAuthDialog(oAuth?: OAuth) {
    const d = this.dialog.open(ViewOauthDialogComponent, {
      data: {
        // title: dialogTitle,
        //modeldata: [],
        modeldata: oAuth,
